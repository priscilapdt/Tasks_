...
function addTarefa(text) {   // cria tarefa
...
tarefasSalvas();
 ...
 botao.addEventListener('click' , function () {  // quando clica faz o evento
 ...
 caixa.addEventListener('keypress' , function(e){  // manda o eveto quando a tecla em questoa e pressionada
...
document.addEventListener('click' , function (e) {
    ...
    if (clear.classList.contains('apagar')) {  // identificar o li que contem a classe apagar
